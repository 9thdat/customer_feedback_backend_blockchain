...
const floopyAddress = "0xacABb1897f9F1461D103Ed123B7527D27C5a6f4E";
...
async function interact() {
    ...
    // Call
    myBalance = await floopyContract.methods.balanceOf(myAddress).call();
    console.log(myBalance);

    //Send
    await web3.eth.accounts.wallet.add("0x" + myPrivateKey);

    receiverBalanceBefore = await floopyContract.methods.balanceOf(recipientAddress).call();
    ...
    receiverBalanceAfter = await floopyContract.methods.balanceOf(recipientAddress).call();
